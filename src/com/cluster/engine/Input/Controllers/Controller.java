...
class Controller {
    ...
    static {
        if(Engine.WINDOWS) {
            ...
            ps4Triggers = new Joystick.Axis[] { Joystick.Axis.Z, Joystick.Axis.R };
            ...
            ps4Thumbsticks = new Joystick.Axis[] { Joystick.Axis.X, Joystick.Axis.Y, Joystick.Axis.U, Joystick.Axis.V };
